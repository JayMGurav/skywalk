...
const roundTripFormSchema = z.object({
...
type RoundTripyFormValues = z.infer<typeof roundTripFormSchema>;
...
export function RoundTripBookingForm() {
  ...
  function onSubmit({
    ...
    const newSearchParams = createQueryString([
      ...
      {name: "returnDate", value: format(returnDate, "yyyy-MM-dd")},
